(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/components/portal-host', ['exports', '@angular/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.components = global['taiga-ui'].cdk.components || {}, global['taiga-ui'].cdk.components['portal-host'] = {}), global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var TuiPortalHostComponent = /** @class */ (function () {
        ...
        TuiPortalHostComponent.prototype.addComponentChild = function (componentFactory, injector) {
            return this.viewContainerRef.createComponent(componentFactory, undefined, core.Injector.create({
                parent: injector,
                providers: [
                    {
        ...
        TuiPortalHostComponent.ctorParameters = function () { return [
            ...
            { type: TuiPortalService, decorators: [{ type: core.Inject, args: [TuiPortalService,] }] }
        ]; };
        __decorate([
        ...
        TuiPortalHostComponent = TuiPortalHostComponent_1 = __decorate([
            ...
            __param(2, core.Inject(TuiPortalService))
    ...
    exports.TuiPortalHostComponent = TuiPortalHostComponent;
    exports.TuiPortalHostModule = TuiPortalHostModule;
