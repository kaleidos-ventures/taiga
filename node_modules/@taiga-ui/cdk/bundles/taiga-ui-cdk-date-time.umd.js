(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taiga-ui/cdk/classes'), require('@taiga-ui/cdk/utils/format'), require('@taiga-ui/cdk/utils/math'), require('@taiga-ui/cdk/constants'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/date-time', ['exports', '@taiga-ui/cdk/classes', '@taiga-ui/cdk/utils/format', '@taiga-ui/cdk/utils/math', '@taiga-ui/cdk/constants', '@angular/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk['date-time'] = {}), global['taiga-ui'].cdk.classes, global['taiga-ui'].cdk.utils.format, global['taiga-ui'].cdk.utils.math, global['taiga-ui'].cdk.constants, global.ng.core));
}(this, (function (exports, classes, format, math, constants, core) { 'use strict';
