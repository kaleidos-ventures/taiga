(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk/constants'), require('@taiga-ui/cdk/tokens'), require('@taiga-ui/cdk/utils/dom'), require('@taiga-ui/cdk/utils/focus'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/directives/auto-focus', ['exports', '@angular/core', '@taiga-ui/cdk/constants', '@taiga-ui/cdk/tokens', '@taiga-ui/cdk/utils/dom', '@taiga-ui/cdk/utils/focus', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives['auto-focus'] = {}), global.ng.core, global['taiga-ui'].cdk.constants, global['taiga-ui'].cdk.tokens, global['taiga-ui'].cdk.utils.dom, global['taiga-ui'].cdk.utils.focus, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, constants, tokens, dom, focus, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiAutoFocusDirective = /** @class */ (function () {
        ...
        TuiAutoFocusDirective.prototype.ngAfterViewInit = function () {
            ...
            if (!this.isIos) {
                setTimeout(function () {
                    focus.setNativeFocused(element);
        ...
        TuiAutoFocusDirective.prototype.veryVerySadIosFix = function (element) {
            ...
            focus.setNativeFocused(decoy);
            rxjs.race(rxjs.timer(IOS_TIMEOUT), rxjs.interval(constants.POLLING_TIME).pipe(operators.map(function () { return dom.getClosestElement(element, NG_ANIMATION_SELECTOR); }), operators.filter(function (element) { return !element; }), operators.take(1))).subscribe(function () {
                setTimeout(function () {
                    focus.setNativeFocused(element);
                    _this.changeDetectorRef.markForCheck();
        ...
        TuiAutoFocusDirective = __decorate([
            ...
            __param(2, core.Self()),
            __param(2, core.Inject(tokens.TUI_FOCUSABLE_ITEM_ACCESSOR)),
            __param(3, core.Inject(tokens.TUI_IS_IOS)),
            __param(4, core.Inject(core.Renderer2)),
            __param(5, core.Inject(core.ViewContainerRef))
