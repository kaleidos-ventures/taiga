(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/directives/autofilled', ['exports', '@angular/core', '@taiga-ui/cdk/observables', '@taiga-ui/cdk/services', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].cdk = global['taiga-ui'].cdk || {}, global['taiga-ui'].cdk.directives = global['taiga-ui'].cdk.directives || {}, global['taiga-ui'].cdk.directives.autofilled = {}), global.ng.core, global['taiga-ui'].cdk.observables, global['taiga-ui'].cdk.services, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var TuiAutofilledDirective = /** @class */ (function () {
        function TuiAutofilledDirective(directiveStyles, _a, changeDetectorRef, destroy$) {
            ...
            observables.typedFromEvent(nativeElement, 'keydown')
                .pipe(operators.take(1), operators.takeUntil(destroy$), observables.watch(changeDetectorRef))
                .subscribe();
        }
        ...
        __decorate([
            core.HostListener('animationstart', ['$event'])
        ...
        TuiAutofilledDirective = __decorate([
            ...
            __param(3, core.Inject(services.TuiDestroyService))
