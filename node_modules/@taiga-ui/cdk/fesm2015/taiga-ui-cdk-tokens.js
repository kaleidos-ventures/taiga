import { InjectionToken, inject, RendererFactory2 } from '@angular/core';
...
const TUI_IS_IOS = new InjectionToken('iOS browser detection', {
    providedIn: 'root',
    factory: () => inject(TUI_IS_MOBILE) && IOS_REG_EXP.test(inject(USER_AGENT).toLowerCase()),
});
...
export { TUI_DEFAULT_RENDERER, TUI_DIALOGS, TUI_FOCUSABLE_ITEM_ACCESSOR, TUI_IS_ANDROID, TUI_IS_IOS, TUI_IS_MOBILE, TUI_SANITIZER };
