(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TuiHostedDropdownConnectorDirective = /** @class */ (function () {
        function TuiHostedDropdownConnectorDirective(elementRef) {
            this.elementRef = elementRef;
        }
        TuiHostedDropdownConnectorDirective.ctorParameters = function () { return [
    ...
    var TuiHostedDropdownComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiHostedDropdownComponent.prototype, "nativeFocusableElement", {
            get: function () {
                return cdk.isNativeKeyboardFocusable(this.host)
                    ? this.host
                    : cdk.getClosestKeyboardFocusable(this.host, false, this.elementRef.nativeElement);
            },
            enumerable: true,
            configurable: true
        });
        ...
        TuiHostedDropdownComponent.prototype.focusDropdown = function (event, first) {
            ...
            var focusable = cdk.getClosestKeyboardFocusable(initial, !first, this.wrapper.nativeElement);
            if (focusable === null) {
                return;
            }
        ...
        __decorate([
            core.ViewChild(cdk.TuiActiveZoneDirective)
        ], TuiHostedDropdownComponent.prototype, "activeZone", void 0);
        __decorate([
            core.ContentChild(TuiHostedDropdownConnectorDirective)
