(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ng-web-apis/common'), require('@taiga-ui/cdk'), require('@taiga-ui/core/constants'), require('@taiga-ui/core/tokens'), require('@angular/common'), require('@taiga-ui/core/components/scroll-controls')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/scrollbar', ['exports', '@angular/core', '@ng-web-apis/common', '@taiga-ui/cdk', '@taiga-ui/core/constants', '@taiga-ui/core/tokens', '@angular/common', '@taiga-ui/core/components/scroll-controls'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].core = global['taiga-ui'].core || {}, global['taiga-ui'].core.components = global['taiga-ui'].core.components || {}, global['taiga-ui'].core.components.scrollbar = {}), global.ng.core, global.common, global.cdk, global['taiga-ui'].core.constants, global['taiga-ui'].core.tokens, global.ng.common, global['taiga-ui'].core.components['scroll-controls']));
}(this, (function (exports, core, common, cdk, constants, tokens, common$1, scrollControls) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiScrollbarComponent = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding('class._container'),
            core.ContentChild(TuiScrollableDirective, { read: core.ElementRef })
        ...
        __decorate([
            core.HostListener(constants.TUI_SCROLL_INTO_VIEW, ['$event'])
