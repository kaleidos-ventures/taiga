(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/field-error', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/tokens', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['field-error'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.tokens, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (exports, core, forms, cdk, core$1, tokens, rxjs, operators, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiFieldErrorComponent = /** @class */ (function () {
        function TuiFieldErrorComponent(ngControl, formArrayName, formGroupName, formGroup, changeDetectorRef, validationErrors) {
            ...
            cdk.tuiAssert.assert(!!this.ngControl, "NgControl not injected in " + this.constructor.name + "!" +
        ...
        TuiFieldErrorComponent.prototype.ngOnInit = function () {
            ...
            this.updateErrorText();
            control.statusChanges.pipe(operators.takeUntil(this.destroy$)).subscribe(function () {
        ...
        TuiFieldErrorComponent.prototype.getErrorText = function () {
            ...
            if (firstError &&
                (firstError instanceof cdk.TuiValidationError ||
                    typeof firstError.message === 'string')) {
                return firstError;
            }
            return firstErrorId
                ? new cdk.TuiValidationError(this.validationErrors[firstErrorId], firstError)
                : null;
        };
        ...
        TuiFieldErrorComponent = __decorate([
            core.Component({
                ...
                animations: [core$1.tuiHeightCollapse, core$1.tuiFadeIn],
            ...
            __param(5, core.Inject(tokens.TUI_VALIDATION_ERRORS))
    ...
    var TuiFieldErrorModule = /** @class */ (function () {
        ...
        TuiFieldErrorModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, forms.ReactiveFormsModule, core$1.TuiErrorModule],
