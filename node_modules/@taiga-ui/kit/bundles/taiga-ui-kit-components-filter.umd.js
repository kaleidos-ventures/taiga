(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@angular/common'), require('@taiga-ui/kit/components/badge'), require('@taiga-ui/kit/components/checkbox-block'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/filter', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@angular/common', '@taiga-ui/kit/components/badge', '@taiga-ui/kit/components/checkbox-block', '@tinkoff/ng-polymorpheus'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.filter = {}), global.ng.core, global.ng.forms, global.cdk, global.ng.common, global['taiga-ui'].kit.components.badge, global['taiga-ui'].kit.components['checkbox-block'], global.ngPolymorpheus));
}(this, (function (exports, core, forms, cdk, common, badge, checkboxBlock, ngPolymorpheus) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TUI_DEFAULT_CONTENT_STRINGIFY = function (item) { return cdk.TUI_DEFAULT_STRINGIFY(item.$implicit); };
