(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/constants'), require('@taiga-ui/kit/providers'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/utils/mask'), require('@taiga-ui/kit/utils/miscellaneous'), require('@tinkoff/ng-polymorpheus'), require('rxjs/operators'), require('@angular/common'), require('angular2-text-mask')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-date', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/constants', '@taiga-ui/kit/providers', '@taiga-ui/kit/tokens', '@taiga-ui/kit/utils/mask', '@taiga-ui/kit/utils/miscellaneous', '@tinkoff/ng-polymorpheus', 'rxjs/operators', '@angular/common', 'angular2-text-mask'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['input-date'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.constants, global['taiga-ui'].kit.providers, global['taiga-ui'].kit.tokens, global['taiga-ui'].kit.utils.mask, global['taiga-ui'].kit.utils.miscellaneous, global.ngPolymorpheus, global.rxjs.operators, global.ng.common, global.angular2TextMask));
}(this, (function (exports, core, forms, cdk, core$1, constants, providers, tokens, mask, miscellaneous, ngPolymorpheus, operators, common, angular2TextMask) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiInputDateComponent = /** @class */ (function (_super) {
        ...
        function TuiInputDateComponent(control, changeDetectorRef, injector, isMobile, dialogService, mobileCalendar, textfieldSize, filler) {
            ...
            _this.items = [];
            _this.defaultActiveYearMonth = cdk.TuiMonth.currentLocal();
            _this.open = false;
            _this.month = null;
            _this.textMaskOptions = {
                mask: constants.TUI_DATE_MASK,
        ...
        TuiInputDateComponent.prototype.onValueChange = function (value) {
            ...
            this.updateValue(value.length !== this.filler.length ? null : cdk.TuiDay.normalizeParse(value));
        };
        ...
        TuiInputDateComponent.prototype.valueIdenticalComparator = function (oldValue, newValue) {
            return cdk.nullableSame(oldValue, newValue, function (a, b) { return a.daySame(b); });
        };
        ...
        TuiInputDateComponent = TuiInputDateComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputDateComponent_1; }),
                    },
                    {
            ...
            __param(7, core.Inject(cdk.TUI_DATE_FILLER))
