(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/providers'), require('rxjs'), require('@angular/common'), require('@taiga-ui/kit/components/calendar-month')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-month-range', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/providers', 'rxjs', '@angular/common', '@taiga-ui/kit/components/calendar-month'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components['input-month-range'] = {}), global.ng.core, global.ng.forms, global.cdk, global.core$1, global['taiga-ui'].kit.providers, global.rxjs, global.ng.common, global['taiga-ui'].kit.components['calendar-month']));
}(this, (function (exports, core, forms, cdk, core$1, providers, rxjs, common, calendarMonth) { 'use strict';
    ...
    var TuiInputMonthRangeComponent = /** @class */ (function (_super) {
        ...
        TuiInputMonthRangeComponent.prototype.onMonthClick = function (month) {
            if (this.value === null || !this.value.isSingleMonth) {
                this.writeValue(new cdk.TuiMonthRange(month, month));
                return;
            }
            this.updateValue(cdk.TuiMonthRange.sort(this.value.from, month));
            this.close();
        };
        ...
        TuiInputMonthRangeComponent.prototype.onActiveZone = function (focused) {
            ...
            if (this.value && this.value.isSingleMonth) {
                this.updateValue(new cdk.TuiMonthRange(this.value.from, this.value.from));
            }
        };
        ...
        TuiInputMonthRangeComponent.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [core$1.TUI_MONTHS,] }] },
        ...
        TuiInputMonthRangeComponent = TuiInputMonthRangeComponent_1 = __decorate([
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiInputMonthRangeComponent_1; }),
                    },
            ...
            __param(2, core.Inject(core$1.TUI_MONTHS)),
