(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@tinkoff/ng-polymorpheus'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/select-option', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@tinkoff/ng-polymorpheus', 'rxjs/operators', '@angular/common'], factory) :
...
}(this, (function (exports, core, forms, cdk, core$1, ngPolymorpheus, operators, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiSelectOptionComponent = /** @class */ (function () {
        function TuiSelectOptionComponent(context, host, option, control) {
            ...
            this.selected$ = cdk.tuiReplayedValueChangesFrom(this.control).pipe(operators.map(function (value) {
        ...
        TuiSelectOptionComponent.prototype.ngOnInit = function () {
            if (cdk.isPresent(this.option.value) && this.host.checkOption) {
        ...
        TuiSelectOptionComponent = __decorate([
            ...
            __param(2, core.Inject(core$1.TuiOptionComponent)),
            __param(3, core.Inject(forms.NgControl))
