(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/kit/abstract'), require('@taiga-ui/kit/tokens'), require('rxjs'), require('@taiga-ui/core')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/slider', ['exports', '@angular/common', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/kit/abstract', '@taiga-ui/kit/tokens', 'rxjs', '@taiga-ui/core'], factory) :
    (global = global || self, factory((global['taiga-ui'] = global['taiga-ui'] || {}, global['taiga-ui'].kit = global['taiga-ui'].kit || {}, global['taiga-ui'].kit.components = global['taiga-ui'].kit.components || {}, global['taiga-ui'].kit.components.slider = {}), global.ng.common, global.ng.core, global.ng.forms, global.cdk, global['taiga-ui'].kit.abstract, global['taiga-ui'].kit.tokens, global.rxjs, global.core$1));
}(this, (function (exports, common, core, forms, cdk, abstract, tokens, rxjs, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiSliderComponent = /** @class */ (function (_super) {
        ...
        TuiSliderComponent.prototype.processStep = function (increment) {
            ...
            var step = this.discrete ? 1 / this.steps : abstract.SLIDER_KEYBOARD_STEP;
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return TuiSliderComponent_1; }),
                    },
                ],
